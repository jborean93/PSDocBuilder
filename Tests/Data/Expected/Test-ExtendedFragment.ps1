Function Test-ExtendedFragment {
    ...
    eventually wrap at around 120 characters long. The sentance should not be in a separate paragraph. Also add a link
    to a cmdlet with 'Cmdlet-Name'.
    ...
    .EXAMPLE Test-ExtendedFragment Example 1
    ...
    .EXAMPLE Test-ExtendedFragment Example 2 scenario
